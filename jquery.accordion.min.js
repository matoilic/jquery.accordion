...
e);if(!b.is(c))b.addClass(a.data.openClass),g=d.data(b[0],"original"),e.complete=function(){d(this).css({overflow:g.overflow})},b.find(">"+a.data.panel).show().animate(g,e)}}var h=d.browser.msie&&parseInt(d.browser.version)<8,f={height:0,marginBottom:0,marginTop:0,paddingBottom:0,paddingTop:0};if(h)f.opacity=0;d.fn.accordion=function(a){var b=d.extend({handle:".handle",panel:".panel",openClass:"open",staticClass:"static",easing:"linear",duration:200,multiple:false,toggle:false,start:1},a||{});b.toggle=
b.multiple||b.toggle;this.each(function(){i(this,b)});return this}})(jQuery);
